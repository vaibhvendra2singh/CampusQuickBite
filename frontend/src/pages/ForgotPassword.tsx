...
const ForgotPassword = () => {
 ...
 return (
 <div className="max-w-md mx-auto mt-20 p-8 card-modern border border-slate-200 shadow-sm rounded-2xl">
 <h2 className="text-3xl font-bold mb-6 text-slate-900 tracking-tight">Recover Access</h2>
 ...
 <div>
 <label className="block text-xs font-semibold text-slate-500 uppercase tracking-widest mb-2">Registered Email</label>
 <input
 type="email"
 value={email}
 onChange={e => setEmail(e.target.value)}
 className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 outline-none transition-all text-sm font-semibold text-slate-900"
 ...
 <p className="text-sm text-slate-500 mb-4 font-medium">Please enter the security token you received along with your new password.</p>
 <div>
 <label className="block text-xs font-semibold text-slate-500 uppercase tracking-widest mb-2">Security Token (UUID)</label>
 <input
 type="text"
 value={token}
 onChange={e => setToken(e.target.value)}
 className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 outline-none transition-all text-sm font-mono text-slate-900"
 placeholder="xxxxxxxx-xxxx-xxxx..."
 required
 />
 </div>
 <div>
 <label className="block text-xs font-semibold text-slate-500 uppercase tracking-widest mb-2">New Password Require</label>
 <input
 type="password"
 value={newPassword}
